        ...
        if (settings.name == '/speechAnalysis') {
          ...
          return MaterialPageRoute(
            builder: (context) => ConversationHealthAnalysisScreen(
              photoId: args?['photoId'] ?? "88fb4bb7-9bf7-4db4-ac24-4b56630c2c5c", // 더미 데이터
              sessionId: args?['sessionId'] ?? "ac259fb9-3fcf-4bf0-9e0e-41651f187d8c", // 더미 데이터
            ),
          );
        }
